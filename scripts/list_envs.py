...
All the environments are registered in the `SpiderBotTraining_1` extension. They start
...
import SpiderBotTraining_1.tasks  # noqa: F401


def main():
    """Print all environments registered in `SpiderBotTraining_1` extension."""
