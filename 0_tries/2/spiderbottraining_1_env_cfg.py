...
class Spiderbottraining1EnvCfg(DirectRLEnvCfg):
    ...
    observation_space = 23 #gonna start off with position of each joint, in real life might need to be only imu data
